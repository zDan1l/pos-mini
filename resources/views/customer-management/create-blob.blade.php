        ...
        <div class="p-6">
            <form id="customerForm" class="space-y-4">
                ...
                <div>
                    ...
                    <button type="button" id="btnOpenCamera" class="mt-3 w-full bg-blue-500 text-white py-3 px-6 rounded-xl hover:bg-blue-600 transition-colors font-semibold flex items-center justify-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-4 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <button type="button" id="btnCapture" class="bg-blue-500 text-white py-3 px-8 rounded-xl hover:bg-blue-600 transition-colors font-semibold flex items-center gap-2">
                    <i class="ph ph-camera"></i>
                    Ambil Foto
                </button>
            </div>

...
<div class="max-w-2xl">
    <form method="POST" action="{{ route('vendor.update-menu', $menu->idmenu) }}" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        @csrf
        @method('PUT')
